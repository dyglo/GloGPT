...
export default function Home() {
  ...
  return (
    <div className={`h-screen flex ${isDarkMode ? 'dark' : ''}`}>
      {/* Sidebar */}
      <div className={`${isSidebarOpen ? 'w-64' : 'w-0'} bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 overflow-hidden`}>
        <div className="p-4">
          ...
          <button 
            ...
            className="w-full flex items-center gap-2 px-3 py-2 text-left rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 mb-6 transition-colors text-gray-700 dark:text-gray-300"
          >
                  ...
                  <div
                    className={`max-w-[80%] rounded-lg p-4 ${
                      message.role === 'user'
                        ...
                        : 'bg-gray-50 dark:bg-gray-800 prose dark:prose-invert prose-sm max-w-none'
                    }`}
                  >
                    {message.role === 'user' ? (
                      message.content
